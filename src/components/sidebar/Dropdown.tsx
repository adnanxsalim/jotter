        ...
        if(fId.length === 2 && fId[1]) {
            ...
            if(error) {
                toast({
                    title: 'Error',
                    variant: 'destructive',
                    description: "Couldn't change file title."
                })
            } else {
                toast({
                    title: 'Success',
        ...
        if(listType === "folder") {
            ...
            if(error) {
                toast({
                    title: "Error",
                    variant: "destructive",
                    description: "Couldn't move folder to trash :("
                })
            } else {
                toast({
                    title: "Success",
        ...
        if(listType === "file") {
            ...
            if(error) {
                toast({
                    title: "Error",
                    variant: "destructive",
                    description: "Couldn't move file to trash :("
                })
            } else {
                toast({
                    title: "Success",
                ...
                <div className={groupIdentifies}>
                    <div className="flex gap-4 items-center justify-center overflow-hidden">
                        ...
                        <input type="text"
                            ...
                            className={clsx('outline-none overflow-hidden w-[140px] text-neutral-400', {
